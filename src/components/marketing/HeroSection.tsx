...
export default function HeroSection() {
  return (
    <section className="relative min-h-[480px] flex items-center overflow-hidden bg-navy">
      ...
      <div className="relative z-10 w-full container-main flex items-center justify-between gap-12 py-16" style={{ paddingLeft: 'var(--container-pad)', paddingRight: 'var(--container-pad)' }}>
