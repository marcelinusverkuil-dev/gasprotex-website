...
export default function CookieBanner({ onAccept }: { onAccept: () => void }) {
  ...
  return (
    <div style={{
      ...
      background: '#0A2238', borderTop: '1px solid rgba(255,255,255,0.08)',
      ...
      <p style={{ fontSize: 13, color: '#C2DCE8', lineHeight: 1.6, margin: 0, maxWidth: 700 }}>
        ...
        Zo verbeteren wij onze dienstverlening. Je gegevens worden anoniem verwerkt.{' '}
        <a href="/privacy" style={{ color: '#F07830', textDecoration: 'underline' }}>Meer informatie</a>.
      </p>
      <div style={{ display: 'flex', gap: 10, flexShrink: 0, marginRight: 80 }}>
        ...
        <button
          onClick={accept}
          style={{ fontSize: 12, color: '#fff', background: '#F07830', border: 'none', borderRadius: 6, padding: '8px 20px', cursor: 'pointer', fontWeight: 600 }}
        >
          Akkoord
        </button>
      </div>
