      ...
      <section style={{ background: '#ffffff', paddingTop: '100px', paddingBottom: '32px' }}>
        <div className="container-main">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[#6B8FA6]" style={{ fontSize: 13 }}>/</span>
            <span className="text-[#6B8FA6]" style={{ fontSize: 13 }}>Welke gassen kun je met akoestische lekdetectie opsporen?</span>
          </div>
          ...
          <div style={{ maxWidth: '720px', marginTop: '48px' }}>
                  ...
                  <tbody>
                    {overzichtTabel.map((rij, i) => (
                      <tr key={rij.gas} style={{ borderTop: '1px solid rgba(10,34,56,0.08)', background: i % 2 === 0 ? 'transparent' : '#FAFBFC' }}>
                        <td className="text-[#0A2238] font-bold" style={{ padding: '10px 14px', fontSize: 13, whiteSpace: 'nowrap' }}>{rij.gas}</td>
                        <td className="text-[#3D5A6E]" style={{ padding: '10px 14px', fontSize: 13, lineHeight: 1.5 }}>{rij.toepassing}</td>
                        <td className="text-[#3D5A6E]" style={{ padding: '10px 14px', fontSize: 13, lineHeight: 1.5 }}>{rij.risico}</td>
                        <td className="text-[#3D5A6E]" style={{ padding: '10px 14px', fontSize: 13, whiteSpace: 'nowrap' }}>{rij.sector}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            {/* Voetnoot */}
            <p className="mt-10" style={{ fontSize: 13, color: '#6B8FA6', fontStyle: 'italic', lineHeight: 1.7 }}>
            ...
            {/* Footer-tekst */}
            <p className="mt-3" style={{ fontSize: 13, color: '#6B8FA6', fontStyle: 'italic', lineHeight: 1.7 }}>
