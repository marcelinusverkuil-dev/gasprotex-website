                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr style={{ background: '#0A2238' }}>
                      <th className="text-left text-white font-semibold" style={{ padding: '10px 14px', fontSize: 13, width: '28%' }}></th>
                      <th className="text-left text-white font-semibold" style={{ padding: '10px 14px', fontSize: 13 }}>Vaste gasdetectie (punt + open-pad)</th>
                      <th className="text-left text-white font-semibold" style={{ padding: '10px 14px', fontSize: 13 }}>Akoestische detectie (ultrasoon)</th>
                    </tr>
                  </thead>
                  <tbody>
                    {vergelijkingstabel.map((rij, i) => (
                      <tr key={rij.eigenschap} style={{ borderTop: '1px solid rgba(10,34,56,0.08)', background: i % 2 === 0 ? 'transparent' : '#FAFBFC' }}>
                        <td className="text-[#0A2238] font-semibold" style={{ padding: '10px 14px', fontSize: 13 }}>{rij.eigenschap}</td>
                        <td className="text-[#3D5A6E]" style={{ padding: '10px 14px', fontSize: 13, lineHeight: 1.5 }}>{rij.vast}</td>
                        <td className="text-[#3D5A6E]" style={{ padding: '10px 14px', fontSize: 13, lineHeight: 1.5 }}>{rij.akoestisch}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
