    ...
    <>
      ...
      <div className="bg-white">
        {diensten.map((d, index) => (
          <section key={d.id} id={d.id} style={{ background: index % 2 === 1 ? '#ffffff' : '#ffffff' }}>
            <div className="max-w-7xl mx-auto py-20 lg:py-28" style={{ paddingLeft: '80px', paddingRight: '80px' }}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-start">

                {/* Links */}
                <div className={`${index % 2 === 1 ? 'lg:order-2' : ''} hover:-translate-y-1 transition-all duration-300`}>
                ...
                <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                  <div className="p-8 lg:p-10 rounded-lg hover:-translate-y-1 hover:shadow-md transition-all duration-300" style={{ background: index % 2 === 1 ? '#ffffff' : '#ffffff', boxShadow: 'none' }}>
                    <div className="flex items-start justify-between gap-4 mb-7 pb-7" style={{ borderBottom: 'none' }}>
                      <div>
      ...
      <section style={{ background: '#0F2D4B' }}>
        <div className="max-w-7xl mx-auto py-16 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8" style={{ paddingLeft: '80px', paddingRight: '80px' }}>
          <div>
            <h2 className="font-display font-black uppercase text-white mb-2" style={{ fontFamily: 'var(--font-barlow-condensed)', fontSize: 'clamp(28px, 4vw, 42px)', lineHeight: 1 }}>
