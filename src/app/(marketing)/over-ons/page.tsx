...
const waarden = [
  {
    icon: '🎯',
    titel: 'Precisie',
    tekst: 'Tot op de centimeter nauwkeurig. Geen schattingen, geen vage zones — exacte locaties die uw onderhoudsdienst direct kan opvolgen.',
  },
  {
    icon: '🛡️',
    titel: 'Veiligheid',
    tekst: 'ATEX-gecertificeerd voor explosiegevaarlijke zones. Detectie op afstand, zonder uw team of installatie te riskeren.',
  },
  {
    icon: '📊',
    titel: 'Transparantie',
    tekst: 'Elk lek krijgt een euro-waarde. Uw directie ziet direct wat lekken kosten — en wat de besparing is na herstel.',
  },
  {
    icon: '⚡',
    titel: 'Snelheid',
    tekst: '10× sneller dan traditionele methoden. Eén specialist, één dag, complete rapportage. Terwijl uw productie doorloopt.',
  },
]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-center">
            <div>
              ...
              <h2
                ...
                style={{ fontFamily: 'var(--font-barlow-condensed)', fontSize: 'clamp(28px, 4vw, 48px)', lineHeight: 1 }}
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                >
                  <div
                    className="font-display font-black text-[#D97737] leading-none mb-1"
      ...
      <section className="bg-[#F4F7FA] py-20 lg:py-28">
        <div className="max-w-7xl mx-auto" style={{ paddingLeft: "80px", paddingRight: "80px" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {waarden.map((w) => (
              <div key={w.titel} className="bg-white p-7 border border-[#E2EAF0]">
                <span className="text-3xl block mb-4">{w.icon}</span>
                <h3
                  className="font-display font-bold uppercase text-[#0F2D4B] mb-3"
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="max-w-7xl mx-auto" style={{ paddingLeft: "80px", paddingRight: "80px" }}>
          <div className="max-w-2xl mx-auto">
            ...
            <h2
              className="font-display font-black uppercase text-[#0F2D4B] leading-none mb-14 text-center"
              style={{ fontFamily: 'var(--font-barlow-condensed)', fontSize: 'clamp(28px, 4vw, 48px)', lineHeight: 1 }}
            >
            ...
            <div className="space-y-0">
              {tijdlijn.map((item, i) => (
                <div
                  ...
                  style={{ borderBottom: i < tijdlijn.length - 1 ? '1px solid #E2EAF0' : 'none' }}
                >
                  <span
                    className="font-display font-black text-[#D97737] flex-shrink-0 w-12"
